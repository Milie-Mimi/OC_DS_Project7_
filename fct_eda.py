''' Librairie personnelle de fonctions d'analyse exploratoire
'''
...
def nan_a_retraiter(df):
    ...
    qui contiennent des valeurs manquantes, le nombred de NaN ainsi que leur dtype
...
def categories_encoder(df, nan_as_category = True):
    ...
    new_columns = [c for c in df.columns if c not in df_columns]
